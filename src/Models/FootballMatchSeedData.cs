...
/// <summary>
/// Provides the initial set of football matches used to seed the data store
/// (Cosmos DB container or in-memory fallback) the first time it is empty.
/// </summary>
public static class FootballMatchSeedData
{
    public static List<FootballMatch> GetMatches() => new()
    {
        new FootballMatch
        {
